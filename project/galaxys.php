...
<head>
    ...
    <title>Galáxias | Calendário Astronômico</title>
...
<body>
    ...
    <?php
        ...
        $query = 'SELECT * FROM GENERIC INNER JOIN GALAXYS ON GENERIC.GEN_CODE = GALAXYS.GAL_GEN_CODE;';
    ...
    <section class="col-md-12 col-sm-12 top-menu">
        ...
        <div class="col-md-11 col-sm-11 title-menu">
			...
			<h1>Calendário Astronômico - <span>Galáxias</span></h1>
		</div>
    ...
    <section class="col-md-12">
        <div class="col-md-12">
			<div class="col-md-12 col-sm-12 div-infos top-infos desktop">
				<div class="col-md-3"> Nome -  Qtd. Estrelas</div>
				<div class="col-md-3"> Descrição da Galáxia</div>
				<div class="col-md-3"> Distância da Terra - Massa</div>
				<div class="col-md-3"> Diâmetro - Espessura</div>
			</div>
			<?php while ($dado = mysqli_fetch_assoc($sql_info)) : ?>
				<!-- Informação Desktop -->
				<div class="col-md-12 col-sm-12 div-infos infos desktop">
					<div class="col-md-3">
						<p><?php echo $dado['GEN_NAME'] ?> - <?php echo $dado['GAL_STARS'] ?></p>
					</div>
					<div class="col-md-3 description-info"><p><?php echo $dado['GEN_DESCRIPTION'] ?></p></div>
					<div class="col-md-3">
						<p><?php echo $dado['GEN_DISTANCE'] ?> Kms - <?php echo $dado['GEN_MASS'] ?></p></div>
					<div class="col-md-3">
						<p><?php echo $dado['GAL_DIAMETER'] ?> UA - <?php echo $dado['GAL_THICKNESS'] ?> UA</p>
					</div>
				</div>
				<!-- Informação Mobile -->
				<div class="col-md-12 col-sm-12 div-infos infos mobile">
					...
					<div>
						<span>Qtd. Estrelas: </span><p><?php echo $dado['GAL_STARS'] ?></p>
					</div>
					<div>
					...
					<div>
						<span>Diâmetro: </span><p><?php echo $dado['GAL_DIAMETER'] ?></p>
					</div>
					<div>
						<span>Espessura: </span><p><?php echo $dado['GAL_THICKNESS'] ?></p>
					</div>
				</div>
            <?php endwhile; ?>
        </div>
