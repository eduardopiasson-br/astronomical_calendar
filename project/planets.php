...
<head>
    ...
    <title>Planetas | Calendário Astronômico</title>
...
<body>
    ...
    <?php
        ...
        $query = 'SELECT * FROM GENERIC INNER JOIN PLANETS ON GENERIC.GEN_CODE = PLANETS.PLA_GEN_CODE;';
    ...
    <section class="col-md-12 col-sm-12 top-menu">
        ...
        <div class="col-md-11 col-sm-11 title-menu">
			...
			<h1>Calendário Astronômico - <span>Planetas</span</h1>
		</div>
			...
			<?php while ($dado = mysqli_fetch_assoc($sql_info)) : ?>
				...
				<div class="col-md-12 col-sm-12 div-infos infos desktop">
                    ...
                    <div class="col-md-3">
                        ...
                        <?php 
                            $code =  $dado['PLA_STA_CODE'];
                            $query2 = "SELECT STA_GEN_CODE FROM STARS WHERE STARS.STA_CODE = '$code';";
				...
				<div class="col-md-12 col-sm-12 div-infos infos mobile">
					...
					<div>
						<span>Tempo por Dia: </span><p><?php echo $dado['PLA_HOURS_DAY'] ?></p>
					</div>
					<div>
					...
					<div>
						<span>Estrela Pertencente: </span><p><?php echo $associated['GEN_NAME'] ?></p>
					</div>
				</div>
            <?php endwhile; ?>
        </div>
