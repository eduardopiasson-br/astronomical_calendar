...
<head>
    ...
    <title>Estrelas | Calendário Astronômico</title>
...
<body>
    ...
    <?php
        ...
        $query = 'SELECT * FROM GENERIC INNER JOIN STARS ON GENERIC.GEN_CODE = STARS.STA_GEN_CODE;';
    ...
    <section class="col-md-12 col-sm-12 top-menu">
        ...
        <div class="col-md-11 col-sm-11 title-menu">
			...
			<h1>Calendário Astronômico - <span>Estrelas</span</h1>
		</div>
    ...
    <section class="col-md-12">
        <div class="col-md-12">
			<div class="col-md-12 col-sm-12 div-infos top-infos desktop">
				<div class="col-md-3"> Nome -  Tipo/Cor</div>
				<div class="col-md-3"> Descrição da Estrela</div>
				<div class="col-md-3"> Distância da Terra - Massa</div>
				<div class="col-md-3"> Sistema Pertencente</div>
			</div>
			<?php while ($dado = mysqli_fetch_assoc($sql_info)) : ?>
				<!-- Informação Desktop -->
				<div class="col-md-12 col-sm-12 div-infos infos desktop">
					<div class="col-md-3">
						<p><?php echo $dado['GEN_NAME'] ?> - <?php echo $dado['STA_COLOR'] ?></p>
					</div>
                    ...
                    <div class="col-md-3">
                        ...
                        <?php 
                            $code =  $dado['STA_SYS_CODE'];
                            $query2 = "SELECT SYS_GEN_CODE FROM SYSTEMS WHERE SYSTEMS.SYS_CODE = '$code';";
				...
				<div class="col-md-12 col-sm-12 div-infos infos mobile">
					...
					<div>
						<span>Tipo/Cor: </span><p><?php echo $dado['STA_COLOR'] ?></p>
					</div>
					<div>
					...
					<div>
						<span>Sistema Pertencente: </span><p><?php echo $associated['GEN_NAME'] ?></p>
					</div>
				</div>
            <?php endwhile; ?>
        </div>
